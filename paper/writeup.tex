...
\author{
  \normalsize\bfseries Team DreamTeam\\[0.25em]
  \normalsize Răzvan-Matei Dedu \hspace{0.35em} Tudor Morariu \hspace{0.35em} Mihnea-Teodor Stoica \hspace{0.35em} David Ștefan Tache
}
\date{}
